...
public interface ReelGameWithFreeGamesSessionConfig extends ReelGameSessionConfig {
    ...
    static Map<String, Map<Integer, Integer>> createDefaultFreeGamesForScattersMap() {
        ...
        entry.put(DefaultReelGameSessionConfig.DEFAULT_MINIMUM_ITEMS_NUM_FOR_SCATTER_WIN, DefaultReelGameWithFreeGamesSessionConfig.DEFAULT_FREE_GAMES_FOR_SCATTERS_NUM);
